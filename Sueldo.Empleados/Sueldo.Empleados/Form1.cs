...
namespace Sueldo.Empleados
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e) {
            //Hace un ejercicio  en C# haciendo uso de matrices, estructuras de repeticion y condiciones que
            //determine el sueldo neto a pagar a un empleado descontando las deduciones correspondientes de ley.
            //isss, afp, isr.
        }
        ...
        private void btnCalcular_Click(object sender, EventArgs e){
            ...
            isss = calcularDeducciones(sueldo, 0.03);    // 3% ISSS
            afp = calcularDeducciones(sueldo, 0.0725);  // 7.25% AFP
